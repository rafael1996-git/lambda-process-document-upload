...
public final class EncryptorKey {
    ...
    public static void initEncryptorKey(String mainKeyVal,
                                        String pwdKeyVal) {
        traderMainKey = mainKeyVal;
        pwdKey = pwdKeyVal;
    }

    private static void validateEncryptorKeys() throws Exception {
    ...
    private static String getDecodedString(String setting,
                                           String mainSettingKey) throws Exception {
        validateEncryptorKeys();
        ...
        byte[] clientKeyBytes = mainSettingKey.getBytes();
